 ...
 *        nome: Emily Duarte
 *        idade: 43
 *        especialidade: Pscicóloga
 *        contato: wb.pscico@gmail
...
router.get('/:id', (req, res) => {
    ...
    ProfessionalsDB = loadProfessionals();
    var Professional = ProfessionalsDB.find((Professional) => Professional.id === id )
...
router.put('/:id', (req, res) => {
    ...
    ProfessionalsDB = loadProfessionals();
    const currentProfessional = ProfessionalsDB.find((Professional) => Professional.id === id )
    const currentIndex = ProfessionalsDB.findIndex((Professional) => Professional.id === id )
...
router.delete('/:id', (req, res) => {
    ...
    const currentProfessional = ProfessionalsDB.find((Professional) => Professional.id === id )
    const currentIndex = ProfessionalsDB.findIndex((Professional) => Professional.id === id )
    if(!currentProfessional) return res.status(404).json({
        "erro": "Aluno não encontrado!"
    })
